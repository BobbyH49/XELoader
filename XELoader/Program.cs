namespace XELoader
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            sqlCommand = $"CREATE NONCLUSTERED INDEX IX_{xer.BatchesTableName}_HashId ON {xer.FullBatchesTableName} (HashId ASC);";
            ...
            sqlCommand = $"CREATE NONCLUSTERED COLUMNSTORE INDEX NCI_{xer.BatchesTableName} ON {xer.FullBatchesTableName} (HashId, Successful, Failed, Aborted, Duration, CpuTime, LogicalReads, PhysicalReads, Writes, [Rowcount]);";
